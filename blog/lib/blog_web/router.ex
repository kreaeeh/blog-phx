defmodule BlogWeb.Router do
  ...
  scope "/", BlogWeb do
    ...
    live "/users/:user_id/posts", PostLive.UserPosts, :index
    ...
    live "/posts/:post_id/comments/:id", CommentLive.Show, :show
    live "/posts/:post_id/comments/:id/show/edit", CommentLive.Show, :edit
